...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('aos'), require('jquery'), require('jquery-countdown'), require('scrollmonitor'), require('flickity'), require('plyr'), require('smooth-scroll'), require('@tanem/svg-injector'), require('typed.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'aos', 'jquery', 'jquery-countdown', 'scrollmonitor', 'flickity', 'plyr', 'smooth-scroll', '@tanem/svg-injector', 'typed.js'], factory) :
  (global = global || self, factory(global.theme = {}, global.AOS, global.jQuery, null, global.scrollMonitor, global.Flickity, global.Plyr, global.SmoothScroll, global.SVGInjector, global.Typed));
}(this, (function (exports, AOS, jQuery$1, jqueryCountdown, scrollMonitor, flickity, Plyr, SmoothScroll, svgInjector, Typed) { 'use strict';
